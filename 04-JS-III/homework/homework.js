...
function empiezaConNueve(n) {
  ...
  if (numeroString[0] === "9" ) {return true}
  else return false;
}
...
function mesesDelAño(array) {
  ...
  if (arrayResultado.length === 3) {return arrayResultado;}
  else{ return "No se encontraron los meses pedidos"}
}
/* if (arrayResultado.includes("Enero") && arrayResultado.includes("Noviembre") && 
arrayResultado.includes("Marzo")) {return arrayResultado}
else return "No se encontraron los meses pedidos"
}*/
